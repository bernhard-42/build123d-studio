...
- **macOS**: MacOS builds are signed ad hoc, with no Developer ID and no notarisation. So, the first open is blocked as an "unidentified developer". Two options:
  - Right-click the app and choose _Open_
  - Run `xattr -dr com.apple.quarantine "/Applications/build123d Studio.app"`.
